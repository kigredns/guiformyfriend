...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			Stroke = Color3.fromRGB(255, 6, 6),
			Divider = Color3.fromRGB(60, 60, 60),
			Text = Color3.fromRGB(255, 6, 6),
			TextDark = Color3.fromRGB(255, 6, 6)
		}
	},
...
CreateElement("Label", function(Text, TextSize, Transparency)
	local Label = Create("TextLabel", {
		Text = Text or "",
		TextColor3 = Color3.fromRGB(255, 6, 6),
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(25, 25, 24), 0, 10), {
			...
			MakeElement("Stroke", Color3.fromRGB(255, 6, 6), 1.2),
			MakeElement("Padding", 12, 12, 12, 12),
			SetProps(MakeElement("Image", NotificationConfig.Image), {
				Size = UDim2.new(0, 20, 0, 20),
				ImageColor3 = Color3.fromRGB(255, 6, 6),
				Name = "Icon"
			}),
...
function OrionLib:MakeWindow(WindowConfig)
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		SetChildren(SetProps(MakeElement("TFrame"), {
			...
			AddThemeObject(SetProps(MakeElement("Label", "By Madhya78", WindowConfig.HidePremium and 14 or 13), {
